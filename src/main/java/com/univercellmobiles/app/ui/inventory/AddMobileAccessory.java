...
import com.univercellmobiles.app.service.AccModelService;
...
public class AddMobileAccessory extends JFrame {
	...
	public AddMobileAccessory() {
		...
		lblModel.setBounds(67, 44, 153, 22);
		panel.add(lblModel);
		...
		modelsList = modelService.getAllModelNames();
		...
		btnAddStock.setBounds(490, 366, 204, 23);
		...
		scrollPane.setBounds(44, 397, 656, 146);
