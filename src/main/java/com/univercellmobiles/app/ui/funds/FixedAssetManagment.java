...
public class FixedAssetManagment extends JFrame {
	...
	public FixedAssetManagment() {
		...
		JButton btnAddExpense = new JButton("Add Fixed Asset");
		...
		JButton btnDeleteBrand = new JButton("Delete Fixed Asset");
